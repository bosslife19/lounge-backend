...
<body>
    <div class="email-container">
        <div class="header">
            <h1>Voucher Received!</h1>
        </div>
        <div class="content">
            <h2>Hi {{$name}}</h2>
            <p>
                Great news! You've just received a payment from <strong>{{$sender}}</strong>.
            </p>
            ...
            <p>
                The funds have been successfully added to your account. You can now use them for transactions.
            </p>
